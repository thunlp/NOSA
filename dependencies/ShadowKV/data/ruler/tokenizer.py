...
class HFTokenizer:
    ...
    def __init__(self, model_path) -> None:
        ...
        # except:
        #     print(f"[ERROR] bad tokenizer {model_path}, now using default")
        self.tokenizer = AutoTokenizer.from_pretrained(model_path, use_fast=True, legacy=False, trust_remote_code=True)
