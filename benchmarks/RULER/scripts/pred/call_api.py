...
if args.server_type == 'hf' or args.server_type == 'gemini' or args.server_type == 'shadowkv':
    args.threads = 1
...
def get_llm(tokens_to_generate):
    ...
    elif args.server_type == 'shadowkv':
        import sys
        ...
        while True:
            try:
                if args.server_type == 'shadowkv':
                    ...
                    output = llm.generate(input_ids, gen_len=llm.tokens_to_generate, temperature=args.temperature)
